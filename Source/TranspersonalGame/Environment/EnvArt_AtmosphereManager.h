...
struct FEnvArt_LightingSettings
{
    ...
    FLinearColor SunColor = FLinearColor(1.0f, 0.8f, 0.6f);
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Atmosphere")
    void ConfigureAtmosphericFog(float Density, float HeightFalloff, FLinearColor Color);

    UFUNCTION(BlueprintCallable, Category = "Atmosphere", CallInEditor)
    void RefreshAtmosphereSettings();
