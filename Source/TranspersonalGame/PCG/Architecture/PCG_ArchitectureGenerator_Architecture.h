...
#include "PCG_ArchitectureGenerator_Architecture.generated.h"

UENUM(BlueprintType)
enum class EPCG_ArchitectureType : uint8
{
...
UENUM(BlueprintType)
enum class EPCG_StructuralCondition : uint8
{
...
struct FArchitectureSpawnData : public FTableRowBase
{
    ...
    EPCG_ArchitectureType StructureType = EPCG_ArchitectureType::EmergencyShelter;
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Architecture")
    EPCG_StructuralCondition Condition = EPCG_StructuralCondition::WellMaintained;
...
protected:
    bool GenerateArchitecturePoints(FPCGContext* Context, const UPCGData* InPointData, UPCGData* OutPointData) const;
    ...
    void GenerateInteriorElements(FPCGContext* Context, const FPCGPoint& StructurePoint, UPCGData* OutPointData) const;
    void GenerateStorytellingElements(FPCGContext* Context, const FPCGPoint& StructurePoint, UPCGData* OutPointData) const;
};