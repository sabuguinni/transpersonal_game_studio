...
#include "PCGGraph.h"
#include "TerrainGenerator_WorldGeneration.generated.h"

UENUM(BlueprintType)
enum class EWorld_BiomeType_E08 : uint8
{
...
struct FBiomeSettings
{
    ...
    EWorld_BiomeType_E08 BiomeType = EWorld_BiomeType_E08::DenseForest;
...
public:
    ...
    EWorld_BiomeType_E08 GetBiomeAtLocation(const FVector& WorldLocation) const;

    UFUNCTION(BlueprintCallable, Category = "Biomes")
    FBiomeSettings GetBiomeSettings(EWorld_BiomeType_E08 BiomeType) const;
...
private:
    ...
    EWorld_BiomeType_E08 CalculateBiomeForLocation(const FVector2D& Location) const;
