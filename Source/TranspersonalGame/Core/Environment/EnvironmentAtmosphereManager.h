...
public:
    ...
    // Biome-specific atmosphere presets
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Biomes")
    TMap<FString, FEnvArt_AtmosphereSettings> BiomeAtmospherePresets;
    ...
    UFUNCTION(BlueprintCallable, Category = "Atmosphere")
    void SetBiomeAtmosphere(const FString& BiomeName);

    UFUNCTION(BlueprintCallable, Category = "Atmosphere")
    FEnvArt_AtmosphereSettings GetCurrentAtmosphereSettings() const;

    UFUNCTION(BlueprintCallable, Category = "Atmosphere")
    EEnvArt_TimeOfDay GetTimeOfDayEnum() const;
