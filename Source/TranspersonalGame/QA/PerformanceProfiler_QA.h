...
#include "PerformanceProfiler_QA.generated.h"
 ...
 */
USTRUCT(BlueprintType)
struct TRANSPERSONALGAME_API FQA_PerformanceMetrics_141
{
    GENERATED_BODY()
...
public:
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "QA Utilities", CallInEditor)
