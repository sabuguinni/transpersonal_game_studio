...
// DISABLED: #include "DinosaurCrowdFragments.h"
#include "DinosaurFlockingProcessor_Crowd.generated.h"
 ...
 */
UCLASS()
class TRANSPERSONALGAME_API UCrowd_DinosaurFlockingProcessor_3C3 : public UMassProcessor
{
    GENERATED_BODY()
