...
#include "DinosaurCrowdSystem_Crowd.generated.h"
 ...
 */
USTRUCT()
struct TRANSPERSONALGAME_API FCrowd_DinosaurBehaviorFragment_7A6 : public FMassFragment
{
    GENERATED_BODY()
 ...
 */
USTRUCT()
struct TRANSPERSONALGAME_API FCrowd_DinosaurHerdFragment : public FMassFragment
{
    GENERATED_BODY()
...
private:
    ...
    void ProcessIdleBehavior(FMassExecutionContext& Context, FCrowd_DinosaurBehaviorFragment_7A6& Behavior, 
                           const FDinosaurTypeFragment& Type, const FTransformFragment& Transform);
    
    void ProcessForagingBehavior(FMassExecutionContext& Context, FCrowd_DinosaurBehaviorFragment_7A6& Behavior,
                               const FDinosaurTypeFragment& Type, FMassVelocityFragment& Velocity);
    
    void ProcessHuntingBehavior(FMassExecutionContext& Context, FCrowd_DinosaurBehaviorFragment_7A6& Behavior,
                              const FDinosaurTypeFragment& Type, FMassVelocityFragment& Velocity);
    
    void ProcessFleeingBehavior(FMassExecutionContext& Context, FCrowd_DinosaurBehaviorFragment_7A6& Behavior,
                              const FDinosaurTypeFragment& Type, FMassVelocityFragment& Velocity);
    
    void UpdateNeeds(FCrowd_DinosaurBehaviorFragment_7A6& Behavior, float DeltaTime);
    void FindNearbyTargets(FMassExecutionContext& Context, const FTransformFragment& Transform,
                          const FDinosaurTypeFragment& Type, FCrowd_DinosaurBehaviorFragment_7A6& Behavior);
};
...
private:
    ...
    void ApplyMovement(FMassExecutionContext& Context, FTransformFragment& Transform,
                      FMassVelocityFragment& Velocity, const FCrowd_DinosaurBehaviorFragment_7A6& Behavior,
 ...
 */
UCLASS()
class TRANSPERSONALGAME_API UCrowd_DinosaurHerdProcessor : public UMassProcessor
{
    GENERATED_BODY()
...
private:
    ...
    void ProcessHerdBehavior(FMassExecutionContext& Context, const FCrowd_DinosaurHerdFragment& Herd,
 ...
 */
UCLASS()
class TRANSPERSONALGAME_API UCrowd_DinosaurCrowdSubsystem : public UWorldSubsystem
{
    GENERATED_BODY()
