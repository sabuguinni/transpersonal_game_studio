...
## MEMORY
→ **Onde colar:** Agente #01 → Memory → Long Term Memory → Instructions → colar o texto abaixo
...
## MEMORY
→ **Onde colar:** Agente #02 → Memory → Long Term Memory → Instructions
...
## MEMORY
→ **Onde colar:** Agente #03 → Memory

```
NÃO activar Long Term Memory.
A sessão Memory (padrão) é suficiente.
```
...
## MEMORY
→ **Onde colar:** Agente #04 → Memory → Long Term Memory → Instructions
...
## MEMORY
→ **Onde colar:** Agente #05 → Memory → Long Term Memory → Instructions
...
## MEMORY
→ **Onde colar:** Agente #07 → Memory → Long Term Memory → Instructions
...
## MEMORY
→ **Onde colar:** Agente #08 → Memory → Long Term Memory → Instructions
...
## MEMORY
→ **Onde colar:** Agente #09 → Memory → Long Term Memory → Instructions
...
## MEMORY
→ **Onde colar:** Agente #12 → Memory → Long Term Memory → Instructions
...
## MEMORY
→ **Onde colar:** Agente #13 → Memory → Long Term Memory → Instructions
...
## MEMORY
→ **Onde colar:** Agente #15 → Memory → Long Term Memory → Instructions
...
## MEMORY
→ **Onde colar:** Agente #18 → Memory → Long Term Memory → Instructions
...
## MEMORY
→ **Onde colar:** Agente #19 → Memory → Long Term Memory → Instructions
